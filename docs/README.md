...
| [evolucao-da-plataforma.md](evolucao-da-plataforma.md) | O que evoluir, por prioridade, com a evidência de cada item |
...
Design assets live in `assets/`. Report and dashboard templates live in [`../templates/`](../templates/INDEX.md).
